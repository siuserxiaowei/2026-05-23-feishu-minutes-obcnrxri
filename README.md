...
2026-05-23 飞书会议纪要归档：自动生成的飞书纪要 GitHub Pages 页面。

English summary: 2026-05-23 Feishu Minutes archive, an auto-generated Feishu Minutes GitHub Pages site.

### Online Entry Points

- GitHub repository: https://github.com/siuserxiaowei/2026-05-23-feishu-minutes-obcnrxri
- Live / GitHub Pages: https://siuserxiaowei.github.io/2026-05-23-feishu-minutes-obcnrxri/
- Default branch: `main`
...
```bash
git clone https://github.com/siuserxiaowei/2026-05-23-feishu-minutes-obcnrxri.git
cd 2026-05-23-feishu-minutes-obcnrxri
```
...
- 妙记：https://vi8r050ecuz.feishu.cn/minutes/obcnrxrigw4n97816tq1jkt4
- 模板：one_page
- 页面：`docs/index.html`
